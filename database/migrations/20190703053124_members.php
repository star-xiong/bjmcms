...
class Members extends Migrator
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table->addColumn('name', 'string',['limit' => 50, 'default'=>'','comment'=>'用户名'])
    	    ...
    	    ->addColumn('login_at', 'timestamp', [ 'default' => 'CURRENT_TIMESTAMP', 'comment' => '最近登录时间'])
