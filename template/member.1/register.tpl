<div class="register-main">
	<div class="register-wp">
		<div class="register-tabtit">
			<ul>
				<li class="active"><a href="javascript:;">手机注册</a></li>
			</ul>
		...
		<div class="register-tabcont">
			<div class="register-form">
				<form onsubmit="return registerSubmit(this);">
					<ul>
						<li>
							<label><em>*</em><span>会员昵称：</span></label>
							<div class="input">
								<input type="text" class="j-input" name="name" id="txtUsername" placeholder="请输入会员账号">
							</div>
						</li>
						<li>
						...
						<li class="liney">
							...
							<div class="input">
								<p class="ltxt">
									...
									<label for="keeptime">我已阅读并同意</label>
									<a href="#" target="_blank">《服务协议》</a>
								</p>
								<input type="hidden" name="__token__" value="{$Request.token}" />
								<button class="regbtn" type="submit">同意协议并注册</button>
							</div>
						</li>
					</ul>
				</form>
