    ...
    ,fullscreen: function(othis){
      ...
      if(iconElem.hasClass(SCREEN_FULL)){
		...
		,switchsite: function() {
			...
			window.location.href = '/admin/index/index/site/'+site_id+'.html';
		}
		
		//清除缓存
		,clearcache: function() {
			$.ajax({
				url:'/admin/system/clearcache.html',
				method:'get',
				dataType:'JSON',
				success:function(res){
					if(res.code == '0'){
		...
		,clearlog: function() {
			$.ajax({
				url:'/admin/system/clearlog.html',
				method:'get',
				dataType:'JSON',
				success:function(res){
					if(res.code == '0'){
